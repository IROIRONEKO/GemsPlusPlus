...
public class GPPRecipeHandler {
	...
	public static void registerCraftingBlocks() {
		...
		GPPCraftingHandler.addShapelessRecipe(new ItemStack(ItemInit.agate, 9), new Object[] {BlockInit.blockagate});
		GPPCraftingHandler.addShapelessRecipe(new ItemStack(ItemInit.amethyst, 9), new Object[] {BlockInit.blockamethyst});
		GPPCraftingHandler.addShapelessRecipe(new ItemStack(ItemInit.chrysocolla, 9), new Object[] {BlockInit.blockchrysocolla});
		GPPCraftingHandler.addShapelessRecipe(new ItemStack(ItemInit.citrine, 9), new Object[] {BlockInit.blockcitrine});
		GPPCraftingHandler.addShapelessRecipe(new ItemStack(ItemInit.garnet, 9), new Object[] {BlockInit.blockgarnet});
		GPPCraftingHandler.addShapelessRecipe(new ItemStack(ItemInit.jade, 9), new Object[] {BlockInit.blockjade});
		GPPCraftingHandler.addShapelessRecipe(new ItemStack(ItemInit.jasper, 9), new Object[] {BlockInit.blockjasper});
		GPPCraftingHandler.addShapelessRecipe(new ItemStack(ItemInit.malachite, 9), new Object[] {BlockInit.blockmalachite});
		GPPCraftingHandler.addShapelessRecipe(new ItemStack(ItemInit.onyx, 9), new Object[] {BlockInit.blockonyx});
		GPPCraftingHandler.addShapelessRecipe(new ItemStack(ItemInit.phoenixite, 9), new Object[] {BlockInit.blockphoenixite});
		GPPCraftingHandler.addShapelessRecipe(new ItemStack(ItemInit.ruby, 9), new Object[] {BlockInit.blockruby});
		GPPCraftingHandler.addShapelessRecipe(new ItemStack(ItemInit.sapphire, 9), new Object[] {BlockInit.blocksapphire});
		GPPCraftingHandler.addShapelessRecipe(new ItemStack(ItemInit.spinel, 9), new Object[] {BlockInit.blockspinel});
		GPPCraftingHandler.addShapelessRecipe(new ItemStack(ItemInit.sugilite, 9), new Object[] {BlockInit.blocksugilite});
		GPPCraftingHandler.addShapelessRecipe(new ItemStack(ItemInit.topaz, 9), new Object[] {BlockInit.blocktopaz});
		GPPCraftingHandler.addShapelessRecipe(new ItemStack(ItemInit.tourmaline, 9), new Object[] {BlockInit.blocktourmaline});
		
		PotionHelper.addMix(PotionTypes.AWKWARD, ItemInit.dustphoenixite, PotionTypes.FIRE_RESISTANCE);
		PotionHelper.addMix(PotionTypes.FIRE_RESISTANCE, ItemInit.phoenixite, PotionTypes.LONG_FIRE_RESISTANCE);
	...
	public static void registerCraftingItems() {
		...
		if (Loader.isModLoaded("gemsplusplusrevamp") == false) {
