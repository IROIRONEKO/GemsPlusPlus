...
public class GPPPhoenixitePickaxe extends ItemPickaxe {

	public GPPPhoenixitePickaxe(IItemTier tier, int attackDamageIn, float attackSpeedIn, Properties builder) {
	...
	public EnumActionResult onItemUse(ItemUseContext p_195939_1_) {
		...
		if (canIgnite(iworld, blockpos)) {
			iworld.playSound(entityplayer, blockpos, SoundEvents.ITEM_FLINTANDSTEEL_USE, SoundCategory.BLOCKS, 1.0F,
	...
	public static boolean canIgnite(IWorld p_201825_0_, BlockPos p_201825_1_) {
		...
		for (EnumFacing enumfacing : EnumFacing.Plane.HORIZONTAL) {
			if (p_201825_0_.getBlockState(p_201825_1_.offset(enumfacing)).getBlock() == Blocks.OBSIDIAN
					&& ((BlockPortal) Blocks.NETHER_PORTAL).isPortal(p_201825_0_, p_201825_1_) != null) {
				flag = true;
			}
		}
