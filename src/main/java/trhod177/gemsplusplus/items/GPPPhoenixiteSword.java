...
public class GPPPhoenixiteSword extends ItemSword implements IHasModel {

	protected String name;
	
	public GPPPhoenixiteSword(String name, ToolMaterial material) {
		super(material);
		this.name = name;
	...
	@Override
	public GPPPhoenixiteSword setCreativeTab(CreativeTabs tab) {
