...
public class GPPPhoenixiteHoe extends ItemHoe implements IHasModel {
	
	protected String name;

	public GPPPhoenixiteHoe(String name, ToolMaterial material) {
		super(material);
		this.name = name;
	...
	@Override
	public GPPPhoenixiteHoe setCreativeTab(CreativeTabs tab) {
