...
public class GPPPhoenixiteShovel extends ItemSpade {

	public GPPPhoenixiteShovel(IItemTier tier, float attackDamageIn, float attackSpeedIn, Properties builder) {
