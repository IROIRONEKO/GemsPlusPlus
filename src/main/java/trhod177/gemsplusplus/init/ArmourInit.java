...
public class ArmourInit {
	...
	public static final ArmorMaterial ARMOUR_EMERALD = EnumHelper.addArmorMaterial("armour_emerald", References.MODID + ":emerald", 44, new int[] {2, 5, 7, 2}, 10, SoundEvents.ITEM_ARMOR_EQUIP_DIAMOND, 0.0F).setRepairItem(new ItemStack(Items.EMERALD));
	//public static final ArmorMaterial ARMOUR_PERIDOT = EnumHelper.addArmorMaterial("armour_peridot", References.MODID + ":peridot", 44, new int[] {2, 5, 7, 2}, 10, SoundEvents.ITEM_ARMOR_EQUIP_DIAMOND, 0.0F).setRepairItem(new ItemStack(ItemInit.peridot));
	...
	/*
	 * public static final ArmourBase helmetperidot = new
	 * ArmourBase("helmetperidot", ARMOUR_PERIDOT, 1,
	 * EntityEquipmentSlot.HEAD).setCreativeTab(GemsPlusPlus.GPPItemsTab); public
	 * static final ArmourBase chestplateperidot = new
	 * ArmourBase("chestplateperidot", ARMOUR_PERIDOT, 1,
	 * EntityEquipmentSlot.CHEST).setCreativeTab(GemsPlusPlus.GPPItemsTab); public
	 * static final ArmourBase leggingsperidot = new ArmourBase("leggingsperidot",
	 * ARMOUR_PERIDOT, 2,
	 * EntityEquipmentSlot.LEGS).setCreativeTab(GemsPlusPlus.GPPItemsTab); public
	 * static final ArmourBase bootsperidot = new ArmourBase("bootsperidot",
	 * ARMOUR_PERIDOT, 1,
	 * EntityEquipmentSlot.FEET).setCreativeTab(GemsPlusPlus.GPPItemsTab);
	 */
}
