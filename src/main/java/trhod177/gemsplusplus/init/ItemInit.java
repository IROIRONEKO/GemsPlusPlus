...
public class ItemInit {
	...
	//public static final ToolMaterial PERIDOT = EnumHelper.addToolMaterial("PERIDOT", 3, 2500, 15f, 3f, 30).setRepairItem(new ItemStack(ItemInit.peridot));
	...
	//public static final GPPItemGem peridot = new GPPItemGem("peridot").setCreativeTab(GemsPlusPlus.GPPItemsTab);
	...
	//public static final GPPCustomAxe axeperidot = new GPPCustomAxe("axeperidot", PERIDOT).setCreativeTab(GemsPlusPlus.GPPItemsTab);
	...
	//public static final GPPCustomPickaxe pickaxeperidot= new GPPCustomPickaxe("pickaxeperidot", PERIDOT).setCreativeTab(GemsPlusPlus.GPPItemsTab);
	...
	//public static final GPPCustomShovel shovelperidot = new GPPCustomShovel("shovelperidot", PERIDOT).setCreativeTab(GemsPlusPlus.GPPItemsTab);
	...
	//public static final GPPCustomHoe hoeperidot = new GPPCustomHoe("hoeperidot", PERIDOT).setCreativeTab(GemsPlusPlus.GPPItemsTab);
	...
	//public static final GPPCustomSword swordperidot = new GPPCustomSword("swordperidot", PERIDOT).setCreativeTab(GemsPlusPlus.GPPItemsTab);
	...
	//public static final GPPItemGem dustperidot = new GPPItemGem("dustperidot").setCreativeTab(GemsPlusPlus.GPPItemsTab);
